...
function ChatInner() {
  ...
  const hydrated = useSyncExternalStore(
    (notify) => useChatSessionStore.persist.onFinishHydration(notify),
    () => useChatSessionStore.persist.hasHydrated(),
    () => false,
  );
  const [landingModelOverride, setLandingModel] = useState<ModelId | null>(null);
  const landingModel = landingModelOverride ?? preferredModel;
