...
export const KIE_PRICES: Record<string, KiePriceRule> = {
  ...
  "grok-imagine-image": { unit: "image", credits: 4, source: docs("grok-imagine/text-to-image") },
  "grok-imagine-image-2": { unit: "image", credits: 4, source: docs("grok-imagine-image-2-0/text-to-image") },
  "qwen-image-3": { unit: "image", credits: 4.8, source: docs("qwen3/text-to-image"), note: "Input images cost 0.5 credits each on image-to-image." },
  "qwen-image-3-pro": { unit: "image", credits: { "1k": 6.4, "2k": 12 }, source: docs("qwen3-pro/text-to-image"), note: "Input images cost 0.5 credits each on image-to-image." },
  "gpt-image-2": gpt,
